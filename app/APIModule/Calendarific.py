...
def getHoliday(state):
    try:
        ...
        if state == "":
            url=f"https://calendarific.com/api/v2/holidays?&api_key={api_key}&country=us&year={current_time.year}&month={current_time.month}&day={current_time.day + 2}"
        else: 
            url=f"https://calendarific.com/api/v2/holidays?&api_key={api_key}&country=us&year={current_time.year}&location=us-{state}&month={current_time.month}&day={current_time.day + 2}"
